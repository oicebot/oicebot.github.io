...
恰好，有一门简单易学的计算机语言，只要你认得26个字母，还记得一点初中的数学知识，就能学会。更加恰好的是，上面说的人工智能、数据分析、网络技术、游戏开发等等等等，都是用这门语言就能实现的技术。这门语言叫做 <span class="hightlight_words">Python</span>。
...
说到这里，也许你已经心动了，也许你还在犹疑，也许你对自己没有信心，这都是非常正常的，没有关系。<span class="hightlight_words">如果你希望给自己更美好的未来，你现在唯一要做的，就是立刻开始行动。</span>给自己一个机会，试一下，踏出你的第一步。
